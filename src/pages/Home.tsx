        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div className="space-y-2 animate-fade-in">
              <div className="text-4xl md:text-5xl font-bold text-gradient-gold">4+</div>
              <p className="text-muted-foreground">{t('about.experience')} {t('about.years')}</p>
            </div>
            ...
            <div className="space-y-2 animate-fade-in delay-400">
              <div className="text-4xl md:text-5xl font-bold text-gradient-gold">8+</div>
